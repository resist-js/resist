...
- Simply start using @resistjs/server. Go through the [Getting Started](https://resistjs.devstart) guide. Does everything work as expected? If not, we're always looking for improvements. Let us know by [opening an issue](#reporting-new-issues).
...
If you have questions about using @resistjs/server, contact us on Discord at [https://resistjs.devchat]((https://resistjs.devchat), and we will do our best to answer your questions.
