...
By contributing to @resistjs/utils, you agree that your contributions will be licensed under its [MIT license](https://github.com/resist-js/resist/blob/master/LICENSE.md).
