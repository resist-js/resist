...
- Simply start using @resistjs/utils. Go through the [Getting Started](https://resistjs.dev/start) guide. Does everything work as expected? If not, we're always looking for improvements. Let us know by [opening an issue](#reporting-new-issues).
- Look through the [open issues](@resistjs/utilsissues). A good starting point would be issues tagged [good first issue](@resistjs/utilsissues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22). Provide workarounds, ask for clarification, or suggest labels. Help [triage issues](#triaging-issues-and-pull-requests).
...
- Take a look at the [features requested](@resistjs/utilslabels/enhancement) by others in the community and consider opening a pull request if you see something you want to work on.
...
If you have questions about using @resistjs/utils, contact us on Slack at [https://resistjs.dev/chat](https://resistjs.dev/chat), and we will do our best to answer your questions.
...
The `@@resistjs/utils/core` @resistjs/utils team will be monitoring for pull requests. Do help us by making your pull request easy to review by following the guidelines above.
...
For changes to be reflected in package changelogs, run `pnpx changeset` and follow the prompts. All changesets should be `patch` until @resistjs/utils 1.0.

### Releases

The [Changesets GitHub action](https://github.com/changesets/action#with-publishing) will create and update a PR that applies changesets and publishes new versions of changed packages to npm.

New packages will need to be published manually the first time if they are scoped to the `@@resistjs/utils` organisation, by running this from the package directory:
...
By contributing to @resistjs/utils, you agree that your contributions will be licensed under its [MIT license](https://github.com/resist-js/resistblob/master/LICENSE.md).
