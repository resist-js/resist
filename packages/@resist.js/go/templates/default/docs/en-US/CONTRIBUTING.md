...
If you'd like to propose an implementation for a large new feature or change then please [create an RFC](https://github.com/~APP_NAME~/rfcs) to discuss it up front.
...
By contributing to ~APP_NAME~, you agree that your contributions will be licensed under its [MIT license](~GITHUB_URL~blob/master/LICENSE.md).
