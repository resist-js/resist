...
<p align="center">
  <a href="~GITHUB_URL~blob/master/docs/en-US/STRUCTURE.md"
    >English</a>
</p>

# Structure

The purpose of this is to describe the overall structure of `~APP_NAME~`, with easy-to-understand descriptions of the purpose of each file within the structure.
...
- [.all-contributorsrc](~GITHUB_URL~blob/master/.all-contributorsrc)
  [What is this?](https://github.com/all-contributors/all-contributors)

> This is a specification for recognizing contributors to an open-source project in a way that rewards each and every contribution, not just code.

- [.czrc](~GITHUB_URL~blob/master/.czrc)
...
- [.editorconfig](~GITHUB_URL~blob/master/.editorconfig)
  [What is this?](https://editorconfig.org/)

> EditorConfig helps maintain consistent coding styles for multiple developers working on the same project across various editors and IDEs.

- [.eslintignore](~GITHUB_URL~blob/master/.eslintignore)
...
- [.eslintrc.json](~GITHUB_URL~blob/master/.eslintrc.json)]
...
- [.gitattributes](~GITHUB_URL~blob/master/.gitattributes)
...
- [.gitignore](~GITHUB_URL~blob/master/.gitignore)
...
- [.prettierignore](~GITHUB_URL~blob/master/.prettierignore)
...
- [.prettierrc](~GITHUB_URL~blob/master/.prettierrc)
...
- [.stylelintrc.json](~GITHUB_URL~blob/master/.stylelintrc.json)
...
- [.xo-config.json](~GITHUB_URL~blob/master/.xo-config.json)
...
- [CODE_OF_CONDUCT.md](~GITHUB_URL~blob/master/CODE_OF_CONDUCT.md)
...
- [CONTRIBUTING.md](~GITHUB_URL~blob/master/CONTRIBUTING.md)
...
- [GOVERNANCE.md](~GITHUB_URL~blob/master/GOVERNANCE.md)
...
- [PROJECT_CHARTER.md](~GITHUB_URL~blob/master/PROJECT_CHARTER.md)
...
- [README.md](~GITHUB_URL~blob/master/README.md)
...
- [pre-push](~GITHUB_URL~blob/master/.githooks/pre-push)
...
> What happens:
>
> - Globally install @~APP_NAME~/conformances
> - Install all dependencies as defined in `package.json`
> - Run `pnpm run check`

- [prepare-commit-msg](~GITHUB_URL~blob/master/.githooks/prepare-commit-msg)
  [What is this?](https://git-scm.com/docs/githooks)
...
- [auto-comment.yml](~GITHUB_URL~blob/master/.github/auto-comment.yml)
...
- [CODE_OWNERS](~GITHUB_URL~blob/master/.github/CODE_OWNERS)
...
- [config.yml](~GITHUB_URL~blob/master/.github/config.yml)
...
- [dependabot.yml](~GITHUB_URL~blob/master/.github/dependabot.yml)
...
- [FUNDING.yml](~GITHUB_URL~blob/master/.github/FUNDING.yml)
...
- [generated-files-bot.yml](~GITHUB_URL~blob/master/.github/generated-files-bot.yml)
...
- [lock.yml](~GITHUB_URL~blob/master/.github/lock.yml)
...
- [PULL_REQUEST_TEMPLATE.md](~GITHUB_URL~blob/master/.github/PULL_REQUEST_TEMPLATE.md)
...
- [SAVED_REPLIES.md](~GITHUB_URL~blob/master/.github/SAVED_REPLIES.md)
...
- [stale.yml](~GITHUB_URL~blob/master/.github/stale.yml)
...
- [bug_report.yml](~GITHUB_URL~blob/master/.github/ISSUE_TEMPLATE/bug_report.yml)
...
- [config.yml](~GITHUB_URL~blob/master/.github/ISSUE_TEMPLATE/config.yml)
  [What is this?](https://docs.github.com/en/communities/using-templates-to-encourage-useful-issues-and-pull-requests/manually-creating-a-single-issue-template-for-your-repository)

> The purpose of this file is to define the default options available when creating an Issue in GitHub Issues.

- [documentation.yml](~GITHUB_URL~blob/master/.github/ISSUE_TEMPLATE/documentation.yml)
  [What is this?](https://docs.github.com/en/communities/using-templates-to-encourage-useful-issues-and-pull-requests/manually-creating-a-single-issue-template-for-your-repository)
...
- [feature_request.yml](~GITHUB_URL~blob/master/.github/ISSUE_TEMPLATE/feature_request.yml)
  [What is this?](https://docs.github.com/en/communities/using-templates-to-encourage-useful-issues-and-pull-requests/manually-creating-a-single-issue-template-for-your-repository)
...
- [automerge.yml](~GITHUB_URL~blob/master/.github/workflows/automerge.yml)
...
- [ci.yml](~GITHUB_URL~blob/master/.github/workflows/ci.yml)
...
> - Install pnpm
> - Install @~APP_NAME~/conformances globally
...
- [codeql.yml](~GITHUB_URL~blob/master/.github/workflows/codeql.yml)
...
- [release.yml](~GITHUB_URL~blob/master/.github/workflows/release.yml)
...
- [stuck.yml](~GITHUB_URL~blob/master/.github/workflows/stuck.yml)
